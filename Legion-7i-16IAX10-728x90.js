...
lib.ssMetadata = [
		{name:"Legion_7i_16IAX10_728x90_atlas_1", frames: [[762,276,50,50],[0,0,728,90],[0,368,392,90],[0,276,400,90],[0,184,530,90],[394,368,369,90],[0,460,327,90],[532,184,364,90],[402,276,358,87],[0,92,713,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["Legion_7i_16IAX10_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.Legion7i16IAX10728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(237,3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(299).to({_off:false},0).wait(31));

	// F6
	this.instance_2 = new lib.F6();
	this.instance_2.setTransform(197,0);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({_off:true},49).wait(31));

	// F5
	this.instance_3 = new lib.F5();
	this.instance_3.setTransform(204,0);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(200).to({_off:false},0).to({_off:true},50).wait(80));

	// F4
	this.instance_4 = new lib.F4();
	this.instance_4.setTransform(179,0);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(150).to({_off:false},0).to({_off:true},50).wait(130));

	// F3
	this.instance_5 = new lib.F3();
	this.instance_5.setTransform(198,0);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(99).to({_off:false},0).to({_off:true},51).wait(180));

	// F2
	this.instance_6 = new lib.F2();
	this.instance_6.setTransform(195,0);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(49).to({_off:false},0).to({_off:true},50).wait(231));

	// F1
	this.instance_7 = new lib.F1();
	this.instance_7.setTransform(171,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},49).wait(281));
...
// library properties:
lib.properties = {
	id: '3CD440DB518B6740A1749B3DB257E90F',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/Legion_7i_16IAX10_728x90_atlas_1.png", id:"Legion_7i_16IAX10_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['3CD440DB518B6740A1749B3DB257E90F'] = {
